          ...
          child: Column(
            ...
            children: [
              ...
              AppButton(
                  ...
                  buttonIcon: SvgPicture.asset(AppImages.google),
              ...
              AppButton(
                  pressedFunction: _handleSignIn,
                  buttonIcon: SvgPicture.asset(AppImages.facebook),
              ...
              AppButton(
                  pressedFunction: _handleSignIn,
                  buttonIcon: SvgPicture.asset(AppImages.apple),
                  buttonColor: AppColors.appBlack,
                  textColor: AppColors.appWhite,
                  buttonText: 'Sign in with iCloud'),
              SizedBox(
                height: height * .02,
              ),
              Row(
              ...
              RichText(
                  text: TextSpan(
                      ...
                      children: [
                    TextSpan(
                        text: "*", style: TextStyle(color: AppColors.appRed)),
                  ])),
              SizedBox(
                height: height * .01,
              ),
